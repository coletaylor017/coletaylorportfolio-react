...
export default class ContactMenu extends Component {
    render() {
        return <div>
            ...
            {this.props.includeResume ? <a href="https://drive.google.com/uc?export=download&id=14-vnH_ujFneJpTCIQp_hVUf1sbsYd4uP" className="btn mb-2 btn-outline-light mr-1">Download my Resume</a> : ""}
	    </div>
    }
}
